  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        />}
        <Image style={{width: 250, height:423, alignSelf: 'center', marginTop: 125}} source={{ uri: 'http://placehold.it/200x200?text='  }} />

        {this.props.cartItems.length==0 && <Text style={styles.emptyTitle}>Cart is empty</Text>}
        {this.props.cartItems.length==0 && <Text style={styles.emptyTitle}> Looks like you haven't made your menu yet </Text>}
