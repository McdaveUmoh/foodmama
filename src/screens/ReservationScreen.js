    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.textInputContainer}>
            <TextInput style={styles.textInput} placeholder="Schedule Details" onChangeText={(text) => this.setState({ detail: text })} value={this.state.detail} placeholderTextColor={AppStyles.color.grey} underlineColorAndroid='transparent' />
          </View>
          <Button containerStyle={styles.buttonContainer} style={styles.buttonText}
            onPress={() => this.onReserve()}>Make Schedule</Button>
        </View>
      </ScrollView>
    );
  }
